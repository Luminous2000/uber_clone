...
const FinishRide = (props) => {
  ...
  return (
    <div className="h-screen">
      ...
      <h3 className="text-2xl font-semibold mb-5">Finish Ride to start!</h3>
      ...
      <div className="flex items-center justify-between p-3 border-2 border-yellow-500 rounded-lg mt-4">
        <div className="flex items-center gap-3  ">
          ...
          <h2 className="text-lg font-medium">
            {props.rideData?.[0].user.fullname.firstname +
              " " +
              props.rideData?.[0].user.fullname.lastname}
          </h2>
        </div>
      ...
      <div className="flex flex-col justify-between items-center gap-2">
        ...
        <div className="mt-6 w-full">
          <button
            onClick={endRide}
            className="w-full mt-3 flex justify-center text-xl bg-green-700 text-white font-semibold p-3 rounded-lg "
          >
            Finish Ride
          </button>
